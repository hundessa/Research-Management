...
const CoordinatorSideNavBar: React.FC = () => {
        ...
        <div className="min-h-screen flex flex-row bg-gray-100 fixed mt-[64px] z-[1000]">
          <div className="flex flex-col w-56 bg-white rounded-r-3xl overflow-hidden">
            <ul className="flex flex-col py-4">
              ...
              <li>
                <a
                  href="/coordinator/researches-list"
                  className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800"
                >
                  <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400">
                ...
                <a
                  href="/coordinator/finance-requests-list"
                  className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800"
                >
                  <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400">
                    <i className="bx bx-book"></i>
...
export default CoordinatorSideNavBar;