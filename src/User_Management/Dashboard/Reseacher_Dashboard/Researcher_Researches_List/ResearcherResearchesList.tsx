        ...
        <section>
          <div className="flex min-w-[1200px] ml-[25%] mt-[10%] bg-gray-100">
            <div className="relative flex flex-col w-full h-full text-slate-700 bg-white shadow-md rounded-xl bg-clip-border">
              <div className="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
                <div className="flex items-center justify-between ">
                  ...
                  <div className="flex flex-col gap-2 shrink-0 sm:flex-row">
                    <button
                      className="flex select-none items-center gap-2 rounded bg-slate-800 py-2.5 px-4 text-xs cursor-pointer font-semibold text-white shadow-md shadow-slate-900/10 transition-all hover:shadow-lg hover:shadow-slate-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                      type="button"
              ...
              {research.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full gap-4 my-12">
                  <p className="text-lg text-slate-500 font-semibold">No researches found.</p>
                </div>
              ) : (
                <div>
                      ...
                      <tr key={index}>
                        ...
                        <td className="p-4 border-b border-slate-200">
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              navigate(`/researcher/researches/${research._id}`)
                            }
                          >
...
export default ResearcherResearchesList;
